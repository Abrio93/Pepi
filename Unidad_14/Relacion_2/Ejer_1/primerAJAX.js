...
function llamarServidor(){
    var puntuacion = document.formulario_puntuacion.puntuacion.value;
    var nombre = document.formulario_puntuacion.nombre.value;
    ...
    xmlhttp.send("nombre=" + nombre + "&puntuacion=" + puntuacion);
}
...
function respuestaServidor() {
    ...
    if (xmlhttp.readyState == 4) {
        ...
        respuesta.append(xmlhttp.responseText);
        }else{
